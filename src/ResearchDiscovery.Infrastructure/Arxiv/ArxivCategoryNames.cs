...
/// Covers every code present in the corpus (cross-listings pull in codes far
/// beyond the harvest target list, so this is broader than the harvest set).
/// </summary>
public static class ArxivCategoryNames
{
    private static readonly IReadOnlyDictionary<string, string> Names =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            // physics archives without subcategories
